...
@WebServlet("/journey/rider/search_detail")
public class JourneyRiderSearchDetailHandler extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      request.getRequestDispatcher("/jsp/journeyRider/search_detail.jsp").include(request, response);
