...
<a id="spreadBtn02" class="btn02" style="font-size:13px; vertical-align:bottom;">카풀관리 ▼</a>
  ...
  <li style="font-size:13px;"><a href='adminlist'>여정 관리</a></li>
  </ul>
    </div>
  </div>
  <div style="margin:35px 0px 0px 80px; float:left;"><a style="background-color:white; font-size:20px;">여정 관리</a></div>
