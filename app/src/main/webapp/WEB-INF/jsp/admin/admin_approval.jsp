  ...
  <div style="background-color:#FAFAFA; float:left; width:800px; height:500px; margin:20px 0px 0px 200px; border-top: solid 7px #BDBDBD;">
    ...
    <thead style="background-color:#D8D8D8;">
      ...
      <tr style="border-top:1px solid; border-bottom:1px solid;">
        ...
        <td id="1">${a.profile != null && a.approval == 0 ? "제출완료" : "승인완료"}</td>
        
        <td id="2" style="background-color:#EFFBFB;">
          ${a.licensePhoto != null && a.approval == 0 ? "제출완료" : "승인완료"}</td>
          
        <td id="3">${a.insurancePhoto != null && a.approval == 0 ? "제출완료" : "승인완료"}</td>
        
        <td id="4" style="background-color:#EFFBFB;">
          ${a.carPhoto != null && a.approval == 0 ? "제출완료" : "승인완료"}</td>
          
        <td id="5">${a.corporationPhoto != null && a.approval == 0 ? "제출완료" : "승인완료"}</td>
        
        <td style="background-color:#EFFBFB;">${a.registeredDate}</td>
        <td><c:if test="${a.approval == 0}">
        
            <a style="color:red;" href="apdetail?mno=${a.mno}">승인대기</a></c:if>
            <c:if test="${a.approval == 1}">
            <a style="color:blue;">승인완료</a></c:if></td>
      </tr>
      </c:forEach>
      </tbody>
    </table>
